...
<div class="p-0 p-md-9 mb-4 col-lg-10">
    <div class="col-md-10 px-0">
    <h1 class="display-4 fst-italic text-center">Judul lagu : {{ $order->judul_lagu }}</h1>
      ...
      <center>
          ...
          @if($order->status_id != 3)<a href="/dashboard/orders/{{ $order->slug }}/edit" class="btn btn-warning mb-3"><span data-feather="edit"></span> Edit</a>
          @endif
      </center>
    </div>
